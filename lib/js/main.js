...
function loadClient() {
    gapi.client.setApiKey("AIzaSyDNAqBtDJoWizz2mTX4oNHfFuXsKSSkWrM");
...
function execute() {
    return gapi.client.youtube.playlistItems.list({
        ...
        .then(function (response) {
            ...
            let sortedplaylistList = create("ul");
            attr(sortedplaylistList, "id", "playlistDisplay");
...
gapi.load("client:auth2", function () {
    gapi.auth2.init({
        ...
        client_id: "198261014688-ugcuuosicgle8s7du2lnobmbjjef2tn8.apps.googleusercontent.com"
    });
});
